				...
				<main>
                    ...
                    <div class="container-fluid mt-4">
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div id="default">
                                    <form id="frmExport" method="post" action="{{ url('DownloadEmpOvertime') }}">
                                    {{ csrf_field() }}
...
$(document).ready(function(){
	...
	var empTable=$("#emptable").DataTable({
			"columns":[{data:'emp_first_name'}, {data:'emp_etfno'}, 
				{data:'OTHRS1'}, {data:'OTHRS2'}, {data:'OTVAL1'},
				{data:'OTVAL2'}, {data:null}],
			"order":[],
			"columnDefs":[{
				"targets":6,
				"render":function(data, type, row){
					var totamt=parseFloat(row.OTVAL1)+parseFloat(row.OTVAL2);
