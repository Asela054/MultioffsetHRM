...
<html>
  <head>
	...
	table.pdf_data tbody tr td:nth-child(4){
		text-align:left;
	} */
	table.pdf_data thead tr th,
	table.pdf_data tbody tr td{
  ...
  <body>
    <div id="" style="padding-left:20px;padding-bottom:20px; padding-right:10px;">
        <table width="100%" style="" border="0" cellpadding="2" cellspacing="0">
            ...
            <tr>
            	<td>TEL: {{ session("company_mobile") }} , {{ session("company_land") }}</td>
        	...
        	<table width="100%" border="0" cellpadding="2" cellspacing="0" class="pdf_data">
                <thead>
                    <tr class="col_border">
                        ...
                        <th style="text-align:center; width:100px;" colspan="">Total Salary</th>
                        <th style="border-left:none; border-right:none; width:5px;">&nbsp;</th>
                ...
                @foreach ($emp_array as $row)
                    ...
                    <tr class="col_border">
                        ...
                        <td style="border-right:none;text-align:left;">{{ $row['emp_nicno'] }}</td>
                        <td style="border-left:none; border-right:none;text-align:left;">&nbsp;</td>
                        <td style="text-align:left;">{{ $row['emp_epfno'] }}</td>
                        <td style="text-align:right;" colspan="">{{ number_format((float)$row['Totalsalary'], 2, '.', ',') }}</td>
                        <td style="border-left:none; border-right:none;text-align:right;">&nbsp;</td>
                        <td style="border-left:none;text-align:right;" colspan="">{{ number_format((float)$row['ETF3'], 2, '.', ',') }}</td>
                  </tr>
                  @endif
                  @php $check++ @endphp
                @endforeach
