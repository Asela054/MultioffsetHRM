              ...
              <table id="maintable">
                  ...
                  <tr>
                    ...
                    <td class="bodytd" width="30%"colspan="2" style="vertical-align: top; border-bottom:none; border-right: none; ">
                      ...
                      <tr>
                        <td class="bodytd" colspan="4" style=" border-left:none; border-right:none;border-bottom:none; padding-top:5px; font-size:12px; text-align:left; vertical-align:top;">
                        @if(!empty($emp_increments_array[$row['pay_profile']]))
                            ...
                            @foreach($emp_increments_array[$row['pay_profile']] as $d)
                                @php 
                                    ...
                                    $increment_details[] = $d['name'] . ' of LKR <b>' . number_format((float)$d['value'], 2, '.', ','). '</b>';  
                                @endphp
                            @endforeach
                            @php 
