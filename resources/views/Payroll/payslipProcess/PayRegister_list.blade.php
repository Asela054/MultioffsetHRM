                                        ...
                                        <div class="card card-header-actions mb-4">
                                            <div class="card-header">
                                                ...
                                                <div>
                                                    ...
                                                    <button type="submit" name="print_record" id="print_record" disabled="disabled" class="btn btn-secondary btn-sm btn-light" onclick="this.form.action='{{ url('DownloadPayRegister') }}'" style="width:auto;" value="1">Download XLS</button>
                                                    <button type="submit" name="print_record" id="print_record_pdf" disabled="disabled" class="btn btn-secondary btn-sm btn-light" onclick="this.form.action='{{ url('DownloadPayRegister') }}'" style="width:auto;" value="2">Download PDF</button>
                                                </div>
                                            </div>
