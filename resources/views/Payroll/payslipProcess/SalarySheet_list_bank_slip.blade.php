                            ...
                            {{ csrf_field() }}	
                                <div class="modal-content">
                                            ...
                                            <div class="form-group col-md-6">
                                               ...
                                               <div class="col">
                                                   <select name="department_filter_id" id="department_filter_id" class="custom-select" style="" data-nestname="deptnest" >
                                                        <option value="" selected="selected"><!--Please Select-->All</option>
                                        	...
                                        	<div class="form-group col-md-6">
                                               ...
                                               <div class="col">
                                                 <select name="payroll_process_type_id" id="payroll_process_type_id" class="form-control" >
                                                    <option value="" data-periodfilter="0" data-totdays="0" disabled="disabled" selected="selected">Please select</option>
                                                    <option value="1" data-periodfilter="0" data-totdays="25" >All</option>
                                                    @foreach($payroll_process_type as $payroll)
                                                    
                                                    <option value="{{$payroll->id}}" data-periodfilter="1" data-totdays="{{$payroll->total_work_days}}">{{$payroll->process_name}}</option>
                                                    @endforeach
                                   ...
                                   <div class="modal-footer form-group d-flex align-items-center justify-content-between" align="">
                                       ...
                                       <div>
                                           <input type="hidden" name="period_filter" id="period_filter" value="0" />
...
$(document).ready(function(){
	...
	$("#payroll_process_type_id").on("change", function(){
		...
		$("#period_filter").val($("#payroll_process_type_id").find(":selected").data('periodfilter'));
	});
