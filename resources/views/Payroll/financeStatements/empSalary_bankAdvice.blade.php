                                            ...
                                            <div class="card-body">
                                                ...
                                                <div id="divPrint" class="datatable table-responsive" style="margin-top:0px;">
                                                    <table class="table table-bordered table-hover" id="emp_bank_table" width="100%" cellspacing="0">
                                                        ...
                                                        <tr>
                                                            <td colspan="4" style="text-align:right;"><strong>Total to be credited:</strong></td>
                                                           <td style="text-align:right;"><label for="" id="totalnetsalry"></label></td>
                                                        </tr>
                                                    </table>
                                                </div>
...
$(document).ready(function(){
    ...
    var empTable = $("#emp_bank_table").DataTable({
        "columns": [
            { data: 'emp_index', className: "text-left" },
            { data: 'emp_first_name', className: "text-left" },
            { data: 'bank_name', className: "text-left" },
            { data: 'emp_bank_acno', className: "text-left" },
            { 
                data: 'emp_netpay', 
        ...
        "createdRow": function(row, data, dataIndex) {
            $(row).attr('id', 'row-' + data.id); // Set the row ID
        }
    });
	  ...
	  $.ajax({
	   ...
	   success:function(data){
		...
		if(data.errors){
            ...
            $("#totalnetsalry").html(parseFloat(data.total_netpay).toFixed(2));
			$("#lbl_duration").show();
...
async function generatePDF() {
    ...
    doc.autoTable({
        ...
        didDrawPage: function (data) {
            ...
            centerTextWithUnderline('Bank Advice', 15, doc);
            ...
            const signyPosition = footerYPosition + 10;
            doc.setFontSize(11);
    ...
    doc.save('Bank Advice' + workfrom + ' to ' + workto + '.pdf');
}
