                    ...
                    <form class="form-horizontal" id="formFilter">
                        <div class="form-row mb-1">
                            <div class="col">
                                ...
                                <select name="company" id="company" class="form-control form-control-sm" required style="pointer-events: none;" readonly>
                                </select>
                            </div>
                            <div class="col">
                            ...
                            <div class="col">
                                ...
                                <input type="date" id="filter_date" name="date" class="form-control form-control-sm" placeholder="yyyy-mm-dd" >
                            </div>
                            <div class="col">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-sm small nowarp" style="width: 100%" id="attendtable">
                                    <thead>
                                    <tr>
                                        <th>Employee ID</th>
                                        <th>Employee Name</th>
...
@section('script')
    ...
    <script>
        $(document).ready(function () {
            ...
            load_dt(companyId,'','','');
            function load_dt(company, date, employee, department) {
                $('#attendtable').DataTable({
                    ...
                    "createdRow": function(row, data, dataIndex) {
                        if (data.in_time_edit_status == 1||data.out_time_edit_status == 1) {
            ...
            $('#formFilter').on('submit',function(e) {
                ...
                load_dt(company, date, employee, department);
            });
