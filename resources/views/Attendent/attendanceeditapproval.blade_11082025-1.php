            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-footer p-2">
                        <button type="button" name="rejectbtn" id="rejectbtn" class="rejectbtn btn btn-danger px-3 btn-sm">Reject</button>
                        <button type="button" name="comfirm_button" id="comfirm_button" class="approvelbtn btn btn-success px-3 btn-sm">Approve</button>
            ...
            <div class="modal-dialog modal-dialog-centered modal-sm">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col text-center">
                                <h4 class="font-weight-normal">Are you sure you want to Reject this data?</h4>
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer p-2">
                        <button type="button" name="reject_button" id="reject_button" class="btn btn-danger px-3 btn-sm">OK</button>
                        <button type="button" class="btn btn-dark px-3 btn-sm" data-dismiss="modal">Cancel</button>
                    </div>
                </div>
            </div>
        ...
        $(document).ready(function() {
            ...
            $('#ok_button').click(function () {
                ...
                // Get the table by ID
                    ...
                    // Get all the td elements in the last row
                    var cells = lastRow.getElementsByTagName("td");
                    // Access the values
                    var editedintime = cells[0].textContent.trim();
                    var editedouttime = cells[1].textContent.trim();
            ...
            $('#reject_button').click(function () {
                ...
                $.ajax({
                    url: '{!! route("attendance_edit_reject") !!}',
                    type: 'POST',
                    dataType: "json",
                    data: {
                        emp_id: emp_id,
