        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header p-2">
                    <h5 class="modal-title" id="staticBackdropLabel">Attendent Breakdown</h5>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#formFilter').on('submit',function(e) {
                ...
                if ($.fn.DataTable.isDataTable('#ot_report_dt')) {
                    $('#ot_report_dt').DataTable().clear().destroy();
                }
                    ...
                    buttons: [{
                            extend: 'excelHtml5',
                            title: 'Report on Department-wise Attendet Total - Multi Offset HRM'
                        },
                        {
                            extend: 'pdf',
                            title: 'Report on Department-wise Attendet Total - Multi Offset HRM',
                    ...
                    serverSide: true,
                    ajax: {
                        url: '{{ route("departmentwise_generateattendentreport") }}',
                        type: 'GET',
                        data: function (d) {
            ...
            $(document).on('click','.view_more',function(e){
                ...
                if ($.fn.DataTable.isDataTable('#empotview')) {
                    $('#empotview').DataTable().clear().destroy();
                }
                ...
                $('#empotview').DataTable({
                    ...
                    serverSide: true,
                    ajax: {
                        url: '{{ route("departmentwise_gettotalattendemployee") }}',
                        type: 'GET',
                        data: function (d) {
                            d.department = depid,
                            d.from_date = $('#from_date').val();
