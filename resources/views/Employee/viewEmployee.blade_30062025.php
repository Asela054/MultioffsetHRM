						...
						<form id="PdetailsForm" class="form-horizontal" method="POST" action="{{ route('empoyeeUpdate') }}" enctype="multipart/form-data">
							...
							<div class="form-row">
								...
								<div class="col">
									...
									<input type="text" class="form-control form-control-sm {{ $errors->has('emp_etfname') ? ' has-error' : '' }}" name="emp_etfname" id="emp_etfname" placeholder=" EPF Name" value="{{$employee->emp_etf_name}}">
