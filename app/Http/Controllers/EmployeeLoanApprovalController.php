    ...
    public function update(Request $request, EmployeeLoan $loan)
    {
		...
		*/
		$form_data = array(
			...
			'loan_approved' => $loan_approved,
			'loan_cancel' => $loan_rejected,
			'approved_by' => $request->user()->id,//'updated_by' => $request->user()->id
