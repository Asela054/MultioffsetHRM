                ...
                foreach ($employeesByDepartment as $departmentName => $employees) {
                    ...
                    foreach ($employees as $employee) {
                        ...
                        if($permission){
                            ...
                            $htmlTables .= '<td><button title="Edit" class="update btn btn-outline-primary btn-sm" data-id="' . $employee['emp_id'] . '" data-date="' . $today . '" data-existing_time_stamp="' . $employee['first_checkin'] . '"><i class="fas fa-pen"></i></button></td>';
                        }
                        else{
