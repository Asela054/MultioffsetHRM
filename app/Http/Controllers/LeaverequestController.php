...
class LeaverequestController extends Controller
{
    ...
    public function insert(Request $request){
        ...
        $covering_employee=$request->input('coveringemployee');
        ...
        $request->covering_employee=$covering_employee;
    ...
    public function getemployeeleaverequest(Request $request){
        ...
        foreach ($data as $row) {
            ...
            $html .= '<td class="text-right"><a name="addrequest" id="' . $row->id . '" class="addrequest btn btn-outline-primary text-primary btn-sm"><i class="fas fa-plus"></i></a></td>';
            $html .= '</tr>';
        }
